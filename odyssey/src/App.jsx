    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/explore"
            element={<Explore token={authToken} />}
          ></Route>
          <Route
            path="/itinerary"
            element={<Itinerary token={authToken} />}
          ></Route>
          <Route path="/trips" element={<Trips token={authToken} />}></Route>
          <Route
            path="/favorites"
            element={<Favorites token={authToken} />}
          ></Route>
          <Route
            path="/profile"
            element={<Profile token={authToken} />}
          ></Route>
          <Route
            path="/preferences"
            element={<UserPreferences token={authToken} />}
          ></Route>
        </Routes>
      </Router>
    </>
